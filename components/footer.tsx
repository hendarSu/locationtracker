...
export function Footer() {
  ...
  const whatsappNumber = "+6285183013901"
    ...
    <footer className="bg-gray-100 border-t mt-auto">
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="mt-4 text-sm text-gray-500">
              Location tracking system for generating and sharing links to track phone locations.
            </p>
          </div>
        ...
        <div className="mt-8 border-t border-gray-200 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500">&copy; {currentYear} Location Tracker. All rights reserved.</p>
